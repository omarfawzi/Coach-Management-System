                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light form-fit bordered">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="{{route('editCompanyDB')}}" class="form-horizontal form-bordered"
                                          method="post" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        <input type="hidden" value="{{$company->id}}" name="companyID">
                                        <div class="form-body" id="editBody">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <select name="manufacture" class="form-control select2"
                                                            aria-describedby="industryChooser-editLocationForm-error">
                                                        <option>{{$company->manufacture}}</option>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Add Group</label>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" name="group[]"
                                                           />
                                                </div>
                                                <div class="col-md-3">
                                                    <a href="javascript:;" id="addGroup" class="btn btn-success">
                                            ...
                                            @foreach($groups as $group)
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <a href="javascript:;"  name="removeGroup" class="btn btn-danger">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#addGroup').click(function () {
                console.log('hi');
                $('#editBody').append('<div class="form-group">' +
                    ' <label class="control-label col-md-3"></label> ' +
                    '<div class="col-md-3"> <input type="text" class="form-control" name="group[]"/> </div> ' +
                    '<div class="col-md-3"> ' +
                    '<button type="button" name="removeGroup" class="btn btn-danger"> <i class="fa fa-close"></i>' +
                    ' Delete</button> </div> </div>');
            });
            $('#editBody').on('click',"[name='removeGroup']",function () {
